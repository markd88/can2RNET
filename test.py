...
if __name__ == "__main__":
    ...
    # rnet_joystick_id = RNET_JSMerror_exploit(can_socket)
    # joyframe = '0C180000#0101'
    # for i in range(0,10):
    #     print(i)
    #     joyframe = '062#40000000' 
    #     cansend(can_socket, joyframe)

    #     joyframe = '062#004' + str(i) + '0000' 
    #     cansend(can_socket, joyframe)

    #     for i in range(50000):
    #         joyframe = '02000200'+'#'+dec2hex(0,2)+dec2hex(50,2)
    #         cansend(can_socket, joyframe)
...
#########################################################################
    ...
    def open():
        ...
        joyframe = '061#52000002' 
        cansend(can_socket, joyframe)


        joyframe = '061#60000000' 
        cansend(can_socket, joyframe)

        joyframe = '061#70000009' 
        cansend(can_socket, joyframe)
        joyframe = '061#80000010' 
        cansend(can_socket, joyframe)


#### 

    # joyframe = '052#00040000' 
    # cansend(can_socket, joyframe)
    # joyframe = '051#12040002' 
    # cansend(can_socket, joyframe)
    # joyframe = '051#92040000' 
    # cansend(can_socket, joyframe)

    # joyframe = '051#82040001' 
    # cansend(can_socket, joyframe)

        joyframe = '062#00410000' 
        cansend(can_socket, joyframe)



        # joyframe = '061#12010002' 
        # cansend(can_socket, joyframe)
        # joyframe = '061#20010000' 
        # cansend(can_socket, joyframe)

   ## 
    # joyframe = '060#30010001' 
    # cansend(can_socket, joyframe)

    


        joyframe = '061#80010080' 
        cansend(can_socket, joyframe)
        ...
        # change ui to tile mode
        # joyframe = '0C180000#0203' 
        # cansend(can_socket, joyframe)
